defmodule Exlivery.Orders.CreteOrUpdate do
  alias Exlivery.Orders.Agent, as: OrderAgent
  alias Exlivery.Users.Agent, as: UserAgent
  alias Exlivery.Orders.{Item, Order}

  def call(%{cpf: user_cpf, items: items}) do
  ...
  defp handle_build(items) do
    if Enum.all?(items, &is_struct/1), do: {:ok, items}, else: {:error, "Any item is invalid!"}
  end
end
